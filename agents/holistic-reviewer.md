...
You run at the end of both phases. At the end of Phase 1 you judge the rolled-up container graph; at the end of Phase 2 you judge the detailed article DAG and content. Apply the same dimensions at the hierarchy level you are given.
...
- For a detailed roadmap, the `kind: article` Markdown pages and their source links.
