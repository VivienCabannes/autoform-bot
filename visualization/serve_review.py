...
from scripts import backend_config  # noqa: E402 — shared CLI/dashboard backend registry
from scripts import dispatch_queue as dq  # noqa: E402 — durable queue contract
from scripts import fslock  # noqa: E402 — shared with dispatch_runner/_queue
from visualization import export_blueprint as eb  # noqa: E402
from visualization import review_model as rm  # noqa: E402

_REPO_ROOT = _PLUGIN_ROOT
...
def make_handler(proj: Project):
    class Handler(BaseHTTPRequestHandler):
        ...
        def _serve_asset(self, name):
            # Only serve files under visualization/assets/ (no traversal).
            safe = Path(name).name
            f = _ASSETS_DIR / safe
            if not f.is_file():
