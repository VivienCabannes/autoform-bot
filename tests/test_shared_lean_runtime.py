...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("AUTOFORM_REPL_MAX_CONTEXTS_PER_PROCESS", "2", "at least 3"),
...
def test_repl_context_limit_is_serialized_and_propagated(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(lean_runtime_module, "LeanReplPool", ConfiguredPool)
