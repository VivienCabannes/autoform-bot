...
def _candidate_gate_result(
    ...
    *,
    ...
    return CandidateGateResult(
        ...
        workspace_project_id=context.work_item.workspace_project_id,
        workspace_project_binding_sha256=(
            context.work_item.workspace_project_binding_sha256
        ),
        blueprint_path=context.work_item.blueprint_path,
