...
1. **uv** — Python package manager (required for the LSP and REPL servers)
...
4. **Lean Explore** (optional) — checks for `LEANEXPLORE_API_KEY` (a key from
...
The optional Lean Explore integration warns but never fails setup if absent.
